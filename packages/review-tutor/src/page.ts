...
<div class="toolbar"><label class="sr-only" for="files">Files</label><select id="files" disabled><option>Files (0)</option></select><button id="previous-file" class="ghost" aria-label="Previous file" disabled>‹</button><button id="next-file" class="ghost" aria-label="Next file" disabled>›</button><button id="select-lines" class="ghost select-toggle" aria-pressed="false">Select lines</button><span id="totals" class="totals"><span class="add">+0</span> <span class="delete">−0</span></span><button id="change-source" class="ghost source-change" hidden>Change source</button></div>
...
<div class="ask-row"><button id="ask" class="primary" aria-busy="false" disabled>Ask</button><button id="cancel" class="ghost" disabled>Cancel</button><span id="question-state" class="pill"></span></div><p id="ask-helper" class="ask-helper">Load a source and enter a question.</p><div id="lifecycle" role="status" aria-live="polite" class="sr-only"></div><div id="error" role="alert" tabindex="-1" class="error"></div><div id="answer" class="answer"><span class="answer-label" aria-hidden="true">Answer</span><div id="answer-text" class="answer-text"></div><div id="answer-tail" class="helper"></div></div></section>
